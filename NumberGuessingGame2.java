...
class NumberGuessingGame2 {
    public static void main(String[] args) {
        ...
        List<Integer> attemptsList = new ArrayList<>(); // List to store attempts used in each game
        List<Boolean> guessedCorrectlyList = new ArrayList<>(); // List to track if user guessed correctly
        ...
        do {
            ...
            guessedCorrectlyList.add(hasGuessedCorrectly); // Store if user guessed correctly
            attemptsList.add(attemptsUsed); // Store attempts used in the current game
        ...
        for (int i = 0; i < gamesPlayed; i++) {
            if (guessedCorrectlyList.get(i)) {
                System.out.println("Game " + (i + 1) + ": Attempts used = " + attemptsList.get(i));
            } else {
                System.out.println("Game " + (i + 1) + ": Attempts used = " + attemptsList.get(i) + " - Wasted");
            }
        }
